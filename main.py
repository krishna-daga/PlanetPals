...
class HomeScreen(Screen):
    def __init__(self, **kwargs):
        ...
        # Create a BoxLayout for vertical arrangement, centered horizontally
        ...
        # Example tasks
        tasks = ["Plant a tree", "Walk the dog", "Do homework"]
        for task in tasks:
            task_label = Label(text=f"- {task}", font_size='18sp', size_hint=(1, None), height=30, halign='left')
        ...
        # # Add Today's Tasks label
        # tasks_label = Label(text="Pick a task for today:", font_size='24sp', bold=True, size_hint=(1, None), height=40)
